...
class ParticipationFinder(
    ...
    fun getParticipatingRoomIds(memberId: UUID): List<UUID> {
        log.debug { "participation.finder.getParticipatingRoomIds memberId=$memberId" }
    ...
    fun countOccupiedSlots(memberId: UUID): Long {
        log.debug { "participation.finder.countOccupiedSlots memberId=$memberId" }
    ...
    fun getSlots(memberId: UUID): ParticipationSlots {
        log.debug { "participation.finder.getSlots memberId=$memberId" }
        return ParticipationSlots.of(countOccupiedSlots(memberId))
    }
    ...
    fun hasAvailableSlot(memberId: UUID): Boolean {
        log.debug { "participation.finder.hasAvailableSlot memberId=$memberId" }
    ...
    fun getRoomParticipations(memberId: UUID, roomIds: Collection<UUID>): List<MemberRoomParticipation> {
        log.debug { "participation.finder.getRoomParticipations memberId=$memberId roomIdsCount=${roomIds.size}" }
    ...
    fun getJoinedParticipants(roomId: UUID): List<JoinedParticipant> {
        log.debug { "participation.finder.getJoinedParticipants roomId=$roomId" }
        return participationRepository
    ...
    fun isParticipating(roomId: UUID, memberId: UUID): Boolean {
        log.debug { "participation.finder.isParticipating roomId=$roomId memberId=$memberId" }
    ...
    fun wasConfirmedParticipant(roomId: UUID, memberId: UUID): Boolean {
        log.debug { "participation.finder.wasConfirmedParticipant roomId=$roomId memberId=$memberId" }
    ...
    fun getConfirmedParticipantIds(roomId: UUID): List<UUID> {
        log.debug { "participation.finder.getConfirmedParticipantIds roomId=$roomId" }
    ...
    fun getHostMemberId(roomId: UUID): UUID {
        log.debug { "participation.finder.getHostMemberId roomId=$roomId" }
        return checkNotNull(
