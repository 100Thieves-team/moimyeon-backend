...
class RoomApplicationFacade(
    ...
    fun accept(hostMemberId: UUID, roomId: UUID, applicationId: Long): ApplicationDecisionResponse =
        roomApplicationService.accept(hostMemberId, roomId, applicationId).toResponse()

    fun reject(hostMemberId: UUID, roomId: UUID, applicationId: Long, reason: String?): ApplicationDecisionResponse =
        roomApplicationService.reject(hostMemberId, roomId, applicationId, reason).toResponse()
    ...
    private fun RoomApplicationView.toResponse(): RoomApplicationResponse =
