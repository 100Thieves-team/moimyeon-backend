...
class ProfileControllerTest : RestDocsTest() {
    ...
    fun setUp() {
        ...
        mockMvc = mockController(ProfileController(profileService), LoginMemberArgumentResolver())
    }
            ...
            .andDo(
                documentApi(
                    ...
                    "닉네임(필수)과 선택 정보를 받아 프로필을 생성하고 프로필 완성 상태로 전환한다. " +
                        "닉네임 형식 위반은 400(E1005), 중복은 409(E1007), 이미 작성된 경우 409(E1008), " +
                        "필수 약관 미동의는 409(E1201)로 응답한다.",
                    requestFields(
